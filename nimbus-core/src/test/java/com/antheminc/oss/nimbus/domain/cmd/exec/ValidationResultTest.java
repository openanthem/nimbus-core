...
public class ValidationResultTest {
	...
	private ValidationResult testee;
	...
	public void testInit() {
		...
		this.testee = new ValidationResult(violations);
	...
	@Test
	public void testAddValidationEmptyErrors() {
		this.testee = new ValidationResult();		
		this.testee.addValidationErrors(new HashSet<>());
		Assert.assertNull(this.testee.getTemplate().get());
	}
}
