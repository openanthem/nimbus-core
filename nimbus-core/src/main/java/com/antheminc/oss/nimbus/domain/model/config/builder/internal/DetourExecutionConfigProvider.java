...
public class DetourExecutionConfigProvider implements ExecutionConfigProvider<DetourConfig> {
	...
	@Override
	public Config getMain(DetourConfig configAnnotation, ExecutionContext eCtx) {
		return configAnnotation.main();
	}

	@Override
	public Config getException(DetourConfig configAnnotation, ExecutionContext eCtx) {
