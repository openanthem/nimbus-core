 ...
 * 
 * <p>
 * This interface is used to describe a component who is able to perform an add
 * operation and return a parent component after interacting with it.
 * 
 * @author Tony Lopez
 * @since 1.1
 *
 ...
 */
public interface AddableComponent<P> {

	/**
	 * <p>
	 * Simulates the user clicking the add button on the component.
	 * 
