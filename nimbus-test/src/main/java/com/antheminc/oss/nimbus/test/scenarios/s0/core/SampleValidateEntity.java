...
public class SampleValidateEntity {
	...
	@ValidateConditional(when = "state == 'hello'", rootScanPath = "../../attr_validate_nested_2/q1/q1_1", targetGroup = GROUP_1.class)
	private String condition_5;
	
	@ValidateConditional(when = "state == 'hello'", rootScanPath = "../../attr_validate_nested_2/q1/q1_1", targetGroup = GROUP_1.class, scope = ValidationScope.SIBLING_NESTED)
	private String condition_6;
	
	@ValidateConditional(when = "state == 'hello'", rootScanPath = "../../attr_validate_nested_2/q1", targetGroup = GROUP_1.class, scope = ValidationScope.CHILDREN)
	private String condition_7;
	
	@ValidateConditional(when = "state == 'hello'", rootScanPath = { "../../attr_validate_nested_2/q1/q1_1", "../../attr_validate_nested_2/q1/nested/q1_2_1"} , targetGroup = GROUP_1.class, scope = ValidationScope.SIBLING)
	private String condition_8;
	
	@ValidateConditional(when = "state == 'hello'", rootScanPath = "../../attr_validate_nested_2", targetGroup = GROUP_1.class, scope = ValidationScope.CHILDREN_NESTED)
