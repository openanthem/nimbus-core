 ...
 */
@Entity
@Table(name="RELATED_CORE_BIDIR_BY_ID")

@Data
public class RelatedCoreBidirectionalById implements RelatedCore {

	@Id @Column(name="ID", nullable=false, unique=true, updatable=false)
	private Long id;
	
	@ManyToOne(targetEntity=RootCore.class)
	@JoinColumn(name="CORE_ID", referencedColumnName="ID", nullable=false, updatable=false)
	private Long coreId;
