 ...
 *
 */
public class TestEventNoOverrideHandler extends EvalExprWithCrudActions<EventNoOverride> {

	public TestEventNoOverrideHandler(BeanResolverStrategy beanResolver) {
		super(beanResolver);
	}
	
	@Override	
	protected void handleInternal(Param<?> onChangeParam, EventNoOverride configuredAnnotation) {
