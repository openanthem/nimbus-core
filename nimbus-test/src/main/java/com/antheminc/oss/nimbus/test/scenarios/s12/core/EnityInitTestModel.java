...
//		)
		@Script(type=Type.SPEL_INLINE, value="findParamByPath('/../parameter2').getState() == 'Value2' ? findParamByPath('/../parameter3').setState('Value3'):''", eventType=OnStateChange.class)
