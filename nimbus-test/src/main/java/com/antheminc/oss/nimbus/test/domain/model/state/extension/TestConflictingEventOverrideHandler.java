 ...
 *
 */
public class TestConflictingEventOverrideHandler extends EvalExprWithCrudActions<ConflictingEventOverride> {

	public TestConflictingEventOverrideHandler(BeanResolverStrategy beanResolver) {
		super(beanResolver);
	}
	
	@Override	
	protected void handleInternal(Param<?> onChangeParam, ConflictingEventOverride configuredAnnotation) {
