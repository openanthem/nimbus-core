 ...
 * 
 * <p>
 * This interface is used to describe a component who is able to be cancelled or
 * closed and should return a parent component after interacting with it.
 * 
 * @author Tony Lopez
 * @since 1.1
 *
 ...
 */
public interface CloseableComponent<P> {

	/**
	 * <p>
	 * Simulates the user clicking the cancel button on the component.
	 * 
	...
	/**
	 * <p>
	 * Simulates the user clicking the close button on the component.
	 * 
	 * @return the parent {@code UnitTestPage} object that would be displayed
	 *         after interacting with the component
	 */
