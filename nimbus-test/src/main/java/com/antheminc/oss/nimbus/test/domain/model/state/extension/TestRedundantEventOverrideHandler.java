 ...
 *
 */
public class TestRedundantEventOverrideHandler extends EvalExprWithCrudActions<RedundantEventOverride> {

	public TestRedundantEventOverrideHandler(BeanResolverStrategy beanResolver) {
		super(beanResolver);
	}
	
	@Override	
	protected void handleInternal(Param<?> onChangeParam, RedundantEventOverride configuredAnnotation) {
