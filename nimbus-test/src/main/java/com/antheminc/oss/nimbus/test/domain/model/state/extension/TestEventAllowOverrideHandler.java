 ...
 *
 */
public class TestEventAllowOverrideHandler extends EvalExprWithCrudActions<EventAllowOverride> {

	public TestEventAllowOverrideHandler(BeanResolverStrategy beanResolver) {
		super(beanResolver);
	}
	
	@Override	
	protected void handleInternal(Param<?> onChangeParam, EventAllowOverride configuredAnnotation) {
