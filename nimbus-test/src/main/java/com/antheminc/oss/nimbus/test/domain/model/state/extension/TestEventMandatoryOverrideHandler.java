 ...
 *
 */
public class TestEventMandatoryOverrideHandler extends EvalExprWithCrudActions<EventMandatoryOverride> {

	public TestEventMandatoryOverrideHandler(BeanResolverStrategy beanResolver) {
		super(beanResolver);
	}
	
	@Override	
	protected void handleInternal(Param<?> onChangeParam, EventMandatoryOverride configuredAnnotation) {
