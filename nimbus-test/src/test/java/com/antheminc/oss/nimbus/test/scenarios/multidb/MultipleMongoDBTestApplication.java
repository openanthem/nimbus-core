 ...
 *
 */
@SpringBootApplication(scanBasePackageClasses = { DefaultCoreConfigMarker.class }, scanBasePackages = {
		"com.antheminc.oss.nimbus.test.scenarios.multidb" })
public class MultipleMongoDBTestApplication {
