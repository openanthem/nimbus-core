...
public class TestCommandFactory {
	...
	public static Command create() {
		Command c = new Command("/hooli/compression/thebox/p/member/_search");
		
		c.createRoot(Type.ClientAlias, "hooli")
			.createNext(Type.ClientOrgAlias, "compression")
			.createNext(Type.AppAlias, "thebox")
	...
	public static Command create_view_searchPatient() {
		...
		Command c = new Command("/hooli/comm/thebox/p/flow_searchpatient/_new");
	...
	public static Command create_view_UserRoleFlow() {
		...
		Command c = new Command("/hooli/comm/thebox/p/flow_user-role/_new");
	...
	public static Command create_icr_UMCaseFlow_findPatient() {
		...
		Command c = new Command("/hooli/comm/thebox/p/flow_umcase/_findPatient");
	...
	public static Command icr_requestType_Update() {
		Command c = new Command("/hooli/comm/thebox/p/flow_umcase/pg1/caseInfo/requestType/_update");
	...
	public static Command autocase_Update() {
		Command c = new Command("/hooli/comm/thebox/p/flow_autocase/pg3/caseName/_update");
