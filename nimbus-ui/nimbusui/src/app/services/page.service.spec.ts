...
import {
  ...
  pageServiceCreateGridDataParam,
  pageServiceModel,
  pageServiceOutputs,
  pageServiceProcessResponse,
  pageServiceRootParam,
  pageServiceRootParam1,
  pageServiceSetViewRootAndNavigateOutput,
  pageServiceTraverseParam,
  pageServiceTraverseParamEventModel,
  pageServiceTraverseParamPayload
} from 'mockdata';
...
describe('PageService', () => {
  ...
  it('getLayoutConfigForFlow() should call the loadDomainFlowConfig()', async(() => {
    ...
    expect(service.loadDomainFlowConfig).toHaveBeenCalledWith(
      'testingFlowName'
    );
  }));
  ...
  it('navigateToDefaultPageForFlow() should call getDetaultPageForFlow() and navigateToPage()', async(() => {
    ...
    expect(service.navigateToPage).toHaveBeenCalledWith(
      pageServiceModel.params[0],
      'ownerlandingview'
    );
    expect(service.getDetaultPageForFlow).toHaveBeenCalledWith(
      pageServiceModel
    );
  }));
  ...
  it('loadDefaultPageForConfig() should call getPageToNavigateTo() and navigateToDefaultPageForFlow()', async(() => {
    ...
    expect(service.getPageToNavigateTo).toHaveBeenCalledWith(
      'next',
      'undefined//undefined:undefined/undefinedundefined/p/t'
    );
    expect(service.navigateToDefaultPageForFlow).toHaveBeenCalledWith(
      'testingModel',
      't'
    );
  ...
  it('getPageConfigById() should return true', async(() => {
    ...
    result.then(data => {
      ...
      expect(service.findMatchingPageConfigById).toHaveBeenCalledWith(
        'pageId',
        'flowName'
      );
    });
  ...
  it('processError() should postResponseProcessing subject with given paramPath', async(() => {
    ...
    expect(service.postResponseProcessing.next).toHaveBeenCalledWith(
      'testingParamPath'
    );
  }));
  ...
  it('invokeFinally() should call loggerService.info() and hideLoader()', async(() => {
    ...
    expect(loggerService.info).toHaveBeenCalledWith(
      'http response for  processed successsfully'
    );
    expect(service.hideLoader).toHaveBeenCalled();
  }));
  ...
  it('traverseFlowConfig() should throw an warning', async(() => {
    ...
    expect(loggerService.warn).toHaveBeenCalledWith(
      'Response cannot be processed for the path /ownerlandingview1 as there is no get/new done on the viewroot '
    );
  }));
  ...
  it('getPageToNavigateTo() should call executeHttp() with flow_/_nav?a=right&b=$execute url', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'flow_/_nav?a=right&b=$execute',
      'GET',
      null
    );
  }));
  ...
  it('getPageToNavigateTo() should call executeHttp() with flow_/ad/_nav?a=right&b=$execute url', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'flow_/ad/_nav?a=right&b=$execute',
      'GET',
      null
    );
  }));
  ...
  it('getFlowNameFromOutput() should return updated flow', async(() => {
    expect(
      service.getFlowNameFromOutput(
        pageServiceProcessResponse['0'].result.outputs[0].value.path
      )
    ).toEqual('ownerlandingview');
  }));
  ...
  it('getNestedElementParam() should call matchNode() and traverseNestedPath()', async(() => {
    ...
    expect(service.traverseNestedPath).toHaveBeenCalledWith(
      param,
      2,
      ['test', '123'],
      'eventPath'
  ...
  it('loadFlowConfig() should call the executeHttp()', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'undefined//undefined:undefined/undefinedundefined/p/test/_new?b=$execute',
      'GET',
      null
    );
  }));
  ...
  it('loadDomainFlowConfig() should call executeHttp()', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'undefined//undefined:undefined/undefinedundefined/p/test:test/_get?b=$execute',
      'GET',
      null
    );
  }));
  ...
  it('loadDomainFlowConfig() should call executeHttp() with null session id', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'undefined//undefined:undefined/undefinedundefined/p/test1/_new?b=$execute',
      'GET',
      null
    );
  }));
  ...
  it('getDetaultPageForFlow() should return model.params[0] value', async(() => {
    expect(service.getDetaultPageForFlow(pageServiceModel)).toEqual(
      pageServiceModel.params[0]
    );
  }));
  ...
  it('setViewRootAndNavigate() should call the navigateToDefaultPageForFlow()', async(() => {
    ...
    service.setViewRootAndNavigate(
      pageServiceSetViewRootAndNavigateOutput,
      'test',
      true,
      true
    ...
    expect(service.navigateToDefaultPageForFlow).toHaveBeenCalledWith(
      pageServiceSetViewRootAndNavigateOutput.value.type.model,
      'test'
    );
  }));
  ...
  it('setViewRootAndNavigate() should call the configservice.setLayoutToAppConfig()', async(() => {
    ...
    viewRoot.layout = '';
    expect(configService.setLayoutToAppConfig).toHaveBeenCalledWith(
      'test',
      viewRoot
    );
  }));
  ...
  it('setViewRootAndNavigate() should update the layout$ event', async(() => {
    ...
    pageServiceSetViewRootAndNavigateOutput.value.config.type.model.uiStyles = {
      attributes: { layout: 'testting layout' }
    };
    service.setViewRootAndNavigate(
      pageServiceSetViewRootAndNavigateOutput,
      'test',
    ...
    expect(service.layout$.emit).toHaveBeenCalledWith(
      pageServiceSetViewRootAndNavigateOutput.value.config.type.model.uiStyles
        .attributes.layout
    );
  }));
  ...
  it('setViewRootAndNavigate() should update the sessionStore with rootDomainId provided', async(() => {
    ...
    pageServiceSetViewRootAndNavigateOutput.r0otDomainId =
      'testingRootDomainId';
    service.setViewRootAndNavigate(
      pageServiceSetViewRootAndNavigateOutput,
      'test',
    ...
    expect(sessionStoreService.set).toHaveBeenCalledWith(
      'test',
      pageServiceSetViewRootAndNavigateOutput.rootDomainId
    );
  }));
  ...
  it('traverseOutput() should call traverseFlowConfig()', async(() => {
    ...
    expect(service.traverseFlowConfig).toHaveBeenCalledWith(
      resOuptuts,
      'ownerlandingview'
    );
  }));
  ...
  it('traverseOutput() should call setViewRootAndNavigate() on _new action', async(() => {
    ...
    spyOn(service, 'setViewRootAndNavigate').and.returnValue('');
    service.traverseOutput(outputs);
    expect(service.setViewRootAndNavigate).toHaveBeenCalledWith(
      outputs[0],
      'ownerlandingview',
      true,
      true
  ...
  it('findMatchingPageConfigById() should return param object based on the pageId and flowName', async(() => {
    expect(
      service.findMatchingPageConfigById('vpOwners', 'ownerlandingview')
    ).toEqual(configServiceFlowConfigs.ownerlandingview.model.params[0]);
  }));

  it('findMatchingPageConfigById() should return param object based on the pageId and flowName with colon in flowname', async(() => {
    expect(
      service.findMatchingPageConfigById('vpOwners', 'ownerlandingview:1')
    ).toEqual(configServiceFlowConfigs.ownerlandingview.model.params[0]);
  }));
  ...
  it('processEvent() should call executeHttp() with undefined//undefined:undefined/undefinedundefined/p/test:test/123/_get?b=t', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'undefined//undefined:undefined/undefinedundefined/p/ownerlandingview:test/vpOwners/vtOwners/vsOwners/owners/_get?b=$execute&pageSize=5&page=0',
      'GET',
      model,
  ...
  it('executeHttp() should call executeHttpGet(), showLoader() and logger.info', async(() => {
    ...
    expect(service.executeHttpGet).toHaveBeenCalledWith(
      '/test',
      'testingParamPath'
    );
  ...
  it('executeHttp() should call executeHttpPost()', async(() => {
    ...
    expect(service.executeHttpPost).toHaveBeenCalledWith(
      '/test',
      {},
      'paramPath'
    );
  ...
  it('postOnChange() should call executeHttp()', async(() => {
    ...
    expect(service.executeHttp).toHaveBeenCalledWith(
      'undefined//undefined:undefined/undefinedundefined/p/event/notify',
      'POST',
      resOuptuts
    );
    expect(loggerService.info).toHaveBeenCalledWith(
      'Post update Event Notify call started for undefined//undefined:undefined/undefinedundefined/p/event/notify'
    );
  }));
  ...
  it('traversePageConfig() should call traversePageConfig()', async(() => {
    ...
    spyOn(service, 'getUpdatedParamPath').and.returnValue(
      '/vfvgOwnerContact/address/address/a/b/a'
    );
    spyOn(service, 'traversePageConfig').and.callThrough();
    service.traversePageConfig(rootParam, eventModel, 1);
    expect(service.traversePageConfig).toHaveBeenCalledWith(
      rootParam.type.model.params[0],
      eventModel,
      2
    );
  ...
  it('traversePageConfig() should call logger.warn()', async(() => {
    ...
    expect(loggerService.warn).toHaveBeenCalledWith(
      'event update with path  did not match with any param of current domain'
    );
  }));
  ...
  it('traversePageConfig() should call processModelEvent()', async(() => {
    ...
    service.traversePageConfig(rootParam, eventModel, 1);
    expect(service.processModelEvent).toHaveBeenCalledWith(
      rootParam.type.model.params[0],
      eventModel
    );
  }));
  ...
  it('processModelEvent() should call createTableBasedData(), replaceSourceParamkeys() and update gridValueUpdate subject', async(() => {
    ...
    spyOn(service, 'createTableBasedData').and.callThrough();
    spyOn(service, 'replaceSourceParamkeys').and.callThrough();
    service.processModelEvent(rootParam, eventModel);
    expect(service.createTableBasedData).toHaveBeenCalledWith(
  ...
  it('traverseNestedPath() should call traverseNestedPath() with element which config.code is not found', async(() => {
    ...
    const rootParam = Object.assign({}, pageServiceRootParam1);
    rootParam.type.model.params.push(
      configServiceFlowConfigs.ownerlandingview.model.params[0].type.model
        .params[0]
    );
    rootParam.type.model.params[0].type.model.params[0].tableBasedData =
      rootParam.tableBasedData;
    rootParam.type.model.params[0].tableBasedData = rootParam.tableBasedData;
    rootParam.type.model.params[0].tableBasedData.values = [];
    service.traverseNestedPath(
      rootParam,
      0,
      ['vtOwners', 'vsSearchOwnerCriteria'],
      'eventPath'
    );
    expect(service.traverseNestedPath).toHaveBeenCalledTimes(3);
    expect(service.traverseNestedPath).toHaveBeenCalledWith(
      rootParam.type.model.params[0].type.model.params[0],
      2,
      ['vtOwners', 'vsSearchOwnerCriteria'],
      'eventPath'
    );
  ...
  it('traverseNestedPath() should return element', async(() => {
    ...
    rootParam.type.model.params[0].tableBasedData = rootParam.tableBasedData;
    rootParam.type.model.params[0].tableBasedData.values = [];
    const res = service.traverseNestedPath(
      rootParam,
      0,
      ['vtOwners'],
      '/ownerlandingview/vpOwners/vtOwners'
    );
    expect(res).toEqual(rootParam.type.model.params[0]);
  }));

  it('processModelEvent() should call createTableBasedData() and update gridValueUpdate subject, rootParam, rootParam.page', async(() => {
    const rootParam = Object.assign({}, pageServiceRootParam1);
    rootParam.tableBasedData.values = null;
    const eventModel = new ModelEvent();
    ...
    spyOn(service.gridValueUpdate, 'next').and.callThrough();
    spyOn(service, 'createTableBasedData').and.returnValue({
      values: 'testingleafstate'
    });
    service.processModelEvent(rootParam, eventModel);
    expect(service.createTableBasedData).toHaveBeenCalledWith(
      eventModel.value.type.model.params,
    ...
    expect(service.gridValueUpdate.next).toHaveBeenCalledWith(rootParam);
    expect(rootParam.tableBasedData.values).toEqual('testingleafstate');
    expect(rootParam.page).toEqual(eventModel.value.page);
  }));

  it('processModelEvent() should call createTableBasedData() and update gridValueUpdate subject, rootParam', async(() => {
    const rootParam = Object.assign({}, pageServiceRootParam1);
    rootParam.tableBasedData.values = null;
    const eventModel = new ModelEvent();
    eventModel.value = {
  ...
  it('updateParam() should call updateNestedParameters()', async(() => {
    ...
    expect(service.updateNestedParameters).toHaveBeenCalledWith(
      pageServiceCreateGridDataParam,
      pageServiceRootParam
    );
    expect(service.replaceSourceParamkeys).toHaveBeenCalledWith(
      pageServiceCreateGridDataParam,
      pageServiceRootParam
    );
    expect(service.eventUpdate.next).toHaveBeenCalledWith(
      pageServiceCreateGridDataParam
    );
    expect(service.validationUpdate.next).toHaveBeenCalledWith(
      pageServiceCreateGridDataParam
    );
  }));
  ...
  it('updateParam() should call logger.debug()', async(() => {
    ...
    expect(loggerService.debug).toHaveBeenCalledWith(
      'Could not process the update from the server for /ownerlandingview/vpOwners/vtOwners/vsOwners/owners because config is undefined.'
    );
  }));
  ...
  it('replaceSourceParamkeys() should call reflect.set()', async(() => {
    ...
    service.replaceSourceParamkeys(
      pageServiceCreateGridDataParam,
      pageServiceRootParam
    );
    expect(Reflect.set).toHaveBeenCalledWith(
      pageServiceCreateGridDataParam,
      'enabled',
      'test'
    );
  ...
  it('updateNestedParameters() should call updateParam()', async(() => {
    ...
    spyOn(loggerService, 'warn').and.callThrough();
    service.updateNestedParameters(
      pageServiceModel.params[0],
      pageServiceTraverseParam
    );
    expect(service.updateParam).toHaveBeenCalledWith(
      pageServiceModel.params[0].type.model.params[0],
      pageServiceTraverseParam.type.model.params[0]
    );
    expect(loggerService.warn).toHaveBeenCalledWith(
      'Detected new params for  /petlayout/vp/vsHeader/vaBanner/vatBannerTab/vcdPetDetails/vcdbPetDetails/vfvgOwnerContact in the update when sourceParam does not have config'
    );
  }));
  ...
  it('updateNestedParameters() should call loggerService.error()', async(() => {
    ...
    expect(loggerService.error).toHaveBeenCalledWith(
      'ERROR: Failure making server call : "Could not find source param to update the nested payload param path/petlayout/vp/vsHeader/vaBanner/vatBannerTab/vcdPetDetails/vcdbPetDetails/vfvgOwnerContact"'
    );
  }));
  ...
  it('executeHttpGet() should make a get call and call invokeFinally(), processResponse()', async(() => {
    ...
    expect(service.invokeFinally).toHaveBeenCalledWith(
      '/test',
      'testParamPath'
    );
  ...
  it('executeHttpGet() should call processError()', async(() => {
    const processError = (error, path) => {
      ...
      expect(error.message).toEqual(
        'Http failure response for /test: 500 Server Error'
      );
      expect(error.name).toEqual('HttpErrorResponse');
      expect(error.ok).toEqual(false);
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with paramPath (with rootCommandURI on _get)', async(() => {
    ...
    service.findParamByCommandUri(
      pageServiceProcessResponse['0'].result.inputCommandUri
    );
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with paramPath (without rootCommandURI on _get)', async(() => {
    ...
    response['0'].result.inputCommandUri =
      '/client/org/app/p/ownerlandingview/vpOwners/vtOwners/vsOwners/owners/_get?b=$execute';
    spyOn(service, 'findParamByAbsolutePath').and.callThrough();
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with empty paramPath (without rootCommandURI _set)', async(() => {
    const response = Object.assign({}, pageServiceProcessResponse);
    response['0'].result.inputCommandUri =
      '/client/org/app/p/ownerlandingview/vpOwners/vtOwners/vsOwners/owners/';
    spyOn(service, 'findParamByAbsolutePath').and.callThrough();
    service.findParamByCommandUri(response['0'].result.inputCommandUri);
    expect(service.findParamByAbsolutePath).toHaveBeenCalledWith('');
  }));
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with paramPath (without rootCommandURI with _nav)', async(() => {
    const response = Object.assign({}, pageServiceProcessResponse);
    response['0'].result.inputCommandUri =
      '/client/org/app/p/ownerlandingview/vpOwners/vtOwners/vsOwners/owners/_nav?b=$execute';
    spyOn(service, 'findParamByAbsolutePath').and.callThrough();
    service.findParamByCommandUri(response['0'].result.inputCommandUri);
    expect(service.findParamByAbsolutePath).toHaveBeenCalledWith(
      '/ownerlandingview/vpOwners/vtOwners/vsOwners/owners'
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with paramPath (without rootCommandURI with _new)', async(() => {
    const response = Object.assign({}, pageServiceProcessResponse);
    response['0'].result.inputCommandUri =
      '/client/org/app/p/ownerlandingview/vpOwners/vtOwners/vsOwners/owners/_new?b=$execute';
    spyOn(service, 'findParamByAbsolutePath').and.callThrough();
    service.findParamByCommandUri(response['0'].result.inputCommandUri);
    expect(service.findParamByAbsolutePath).toHaveBeenCalledWith(
      '/ownerlandingview/vpOwners/vtOwners/vsOwners/owners'
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with paramPath (without rootCommandURI with _update)', async(() => {
    const response = Object.assign({}, pageServiceProcessResponse);
    response['0'].result.inputCommandUri =
      '/client/org/app/p/ownerlandingview/vpOwners/vtOwners/vsOwners/owners/_update?b=$execute';
    spyOn(service, 'findParamByAbsolutePath').and.callThrough();
    service.findParamByCommandUri(response['0'].result.inputCommandUri);
    expect(service.findParamByAbsolutePath).toHaveBeenCalledWith(
      '/ownerlandingview/vpOwners/vtOwners/vsOwners/owners'
  ...
  it('findParamByCommandUri() should call findParamByAbsolutePath with paramPath (without rootCommandURI with _update) and domainFlowPath with :', async(() => {
    const response = Object.assign({}, pageServiceProcessResponse);
    response['0'].result.inputCommandUri =
      '/client/org/app/p/ownerlandingview/test:vpOwners/vtOwners/vsOwners/owners/_update?b=$execute';
    spyOn(service, 'findParamByAbsolutePath').and.callThrough();
    service.findParamByCommandUri(response['0'].result.inputCommandUri);
    expect(service.findParamByAbsolutePath).toHaveBeenCalledWith(
      '/ownerlandingview/test/test:vpOwners/vtOwners/vsOwners/owners'
    );
  }));

  it('findParamByAbsolutePath() should return root param', async(() => {
    expect(
      service.findParamByAbsolutePath(
        configServiceFlowConfigs.ownerlandingview.model.params[0].type.model
          .params[0].path
      )
    ).toEqual(
