...
export class ConstraintMapping extends Enum<string> {
  public static readonly required = new Enum(
    ValidationConstraint._notNull.value
  );
  public static readonly isNotEmpty = new Enum(
    ValidationConstraint._notEmpty.value
  );
  public static readonly pattern = new Enum(
    ValidationConstraint._pattern.value
  );
  public static readonly minMaxSelection = new Enum(
    ValidationConstraint._size.value
  );
