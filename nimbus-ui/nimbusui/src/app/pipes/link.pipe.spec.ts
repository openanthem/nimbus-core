...
describe('LinkPipe', () => {
  ...
  it('pipe should return updated anchor tag with http', () => {
    expect(pipe.transform('http://test.com', '/path/test')).toEqual(
      '<a href="http://test.com" target="_blank">http://test.com</a>'
    );
  });

  it('pipe should return updated anchor tag with www', () => {
    expect(pipe.transform('www.test.com', '/path/test')).toEqual(
  ...
  it('pipe should return updated anchor tag with mailto: in href attribute', () => {
    expect(pipe.transform('test@gmail.com', '/path/test')).toEqual(
