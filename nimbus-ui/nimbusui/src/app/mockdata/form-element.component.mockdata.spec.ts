...
export const formInput: any = {
  ...
  configId: '596',
  path:
    '/ownerlandingview/vpOwners/vtOwners/vsSearchOwnerCriteria/vfSearchOwnerCriteria/Formelementgroup1/firstName',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formTreeGrid: any = {
      ...
      elementConfig: {
        ...
        type: {
          ...
          model: {
            ...
            paramConfigIds: ['405', '406', '407', '408', '412']
          }
        }
      }
    }
  ...
  configId: '584',
  path:
    '/ownerlandingview/vpOwners/vtOwners/vsSearchOwnerCriteria/vfSearchOwnerCriteria/treegrid',
  type: {
    model: {
      params: []
    }
...
export const formUpload: any = {
  ...
  configId: '908',
  path:
    '/petassessmentview/vpMain/vtMain/vsPetGeneralAssessment/petForm/petFormBody/petAssessment_Accordion_tab/q9/q9_b',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formCheckBoxGrp: any = {
  ...
  configId: '895',
  path:
    '/petassessmentview/vpMain/vtMain/vsPetGeneralAssessment/petForm/petFormBody/petAssessment_Accordion_tab/surveyLabel',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formRadio: any = {
  ...
  configId: '873',
  path:
    '/petassessmentview/vpMain/vtMain/vsPetGeneralAssessment/petForm/petFormBody/petAssessment_Accordion_tab/q1/q1_a',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formSignature: any = {
  ...
  configId: '915',
  path:
    '/petassessmentview/vpMain/vtMain/vsPetGeneralAssessment/petForm/petFormBody/petAssessment_Accordion_tab/q13',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formComboBox: any = {
  ...
  configId: '481',
  path:
    '/ownerview/vpAddEditOwner/vtAddEditOwner/vsAddEditOwner/vfAddEditOwner/notificationPreference',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formCheckBox: any = {
  ...
  configId: '480',
  path:
    '/ownerview/vpAddEditOwner/vtAddEditOwner/vsAddEditOwner/vfAddEditOwner/shouldUseNickname',
  type: {},
  message: [],
  values: [],
  labels: [
...
export const formMultiSelectCard: any = {
  ...
  configId: '589',
  path:
    '/ownerlandingview/vpOwners/vtOwners/vsSearchOwnerCriteria/vfSearchOwnerCriteria/testingmulticard',
  type: {
    nested: false,
    name: 'string',
    collection: false
...
export const formMultiSelect: any = {
  ...
  configId: '579',
  path:
    '/ownerlandingview/vpOwners/vtOwners/vsSearchOwnerCriteria/vfSearchOwnerCriteria/userGroups',
  type: {},
  message: [
    {
      messageArray: [
...
export const formRichText = {
  ...
  configId: '503',
  path:
    '/ownerview/vpAddEditOwner/vtAddEditOwner/vsAddEditOwner/vfAddEditOwner/richTextbox',
  type: {
    nested: false,
    name: 'string',
    collection: false
