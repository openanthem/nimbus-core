...
import { tableElement, tableGridValue, tableGridValueUpdate, tableParams } from 'mockdata';
...
import { ConfigType, ParamConfig, UiAttribute, UiStyle } from '../../../shared/param-config';
