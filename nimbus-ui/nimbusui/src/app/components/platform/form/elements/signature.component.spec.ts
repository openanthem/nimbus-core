...
describe('Signature', () => {
  ...
  beforeEach(() => {
    ...
    hostComponent.element = signatureElement;
  ...
  it('on click of the zoom out button the shrinkCanvas() should be called',async(() => {
    ...
    expect(allButtonEle.length > 0).toBeTruthy();
    allButtonEle[2].nativeElement.click();
    console.log('hostComponent.zoomFactor', hostComponent.zoomFactor);
    fixture.detectChanges();
    console.log('hostComponent.zoomFactor--1', hostComponent.zoomFactor);

    fixture.whenStable().then(() => {
      const allButtonEle1 = debugElement.queryAll(By.css('button'));

      console.log('allButtonEle--139', allButtonEle1);
      console.log('allButtonEle[0]', allButtonEle1[0].nativeElement.innerText);
      console.log('allButtonEle[1]', allButtonEle1[1].nativeElement.innerText);
      console.log('allButtonEle[2]', allButtonEle1[2].nativeElement.innerText);
      console.log('allButtonEle[3]', allButtonEle1[3].nativeElement.innerText);
    });
