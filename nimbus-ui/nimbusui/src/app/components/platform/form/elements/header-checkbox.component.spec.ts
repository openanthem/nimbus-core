...
describe('HeaderCheckBox', () => {
  ...
  it('should create the HeaderCheckBox', async function(this: TestContext<
    HeaderCheckBox
  >) {
    expect(hostComponent).toBeTruthy();
  });

  it('selectingAll() should update dt.selection and headerChckbxState', async function(this: TestContext<
    HeaderCheckBox
  >) {
  ...
  it('selectingAll() should update dt.selection and headerChckbxState and call onClickSelectAll()', async function(this: TestContext<
    HeaderCheckBox
  >) {
    fixture.whenStable().then(() => {
      hostComponent.dt = {
  ...
  it('onClickSelectAll() should call dt.toggleRowsWithCheckbox()', async function(this: TestContext<
    HeaderCheckBox
  >) {
    hostComponent.dt = {
      toggleRowsWithCheckbox: (a, b) => {},
  ...
  it('onClickSelectAll() should not call dt.toggleRowsWithCheckbox()', async function(this: TestContext<
    HeaderCheckBox
  >) {
    hostComponent.dt = {
      toggleRowsWithCheckbox: (a, b) => {},
  ...
  it('updateToggleRowsWithCheckbox() should update dt.toggleRowsWithCheckbox', async function(this: TestContext<
    HeaderCheckBox
  >) {
  ...
  it('dt.toggleRowsWithCheckbox() should update dt.preventSelectionSetterPropagation and call dt.updateSelectionKeys(), dt.tableService.onSelectionChange', async function(this: TestContext<
    HeaderCheckBox
  >) {
    hostComponent.dt = {
      updateSelectionKeys: () => {},
  ...
  it('ngOnInit() should update headerChckbxState as true', async function(this: TestContext<
    HeaderCheckBox
  >) {
    fixture.whenStable().then(() => {
      const sChange = observableOf([1, 2, 3, 4, 5]);
      hostComponent.dt = {
        selectionChange: sChange,
        first: 0,
        value: [1, 2, 3, 4, 5],
        onPage: observableOf({
          first: ''
  ...
  it('ngOnInit() should update headerChckbxState as false', async function(this: TestContext<
    HeaderCheckBox
  >) {
    fixture.whenStable().then(() => {
      const sChange = observableOf([1, 2, 3, 4, 5]);
  ...
  it('ngOnInit() should update headerChckbxState and call updateToggleRowsWithCheckbox()', async function(this: TestContext<
    HeaderCheckBox
  >) {
    fixture.whenStable().then(() => {
      const sChange = observableOf([1, 2, 3, 4, 5]);
