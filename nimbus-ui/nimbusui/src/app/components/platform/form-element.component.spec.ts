...
import { formCalendar, formCheckBox, formCheckBoxGrp, formComboBox, formInput, formInputSwitch, formMultiSelect, formMultiSelectCard, formPicklist, formRadio, formRichText, formSignature, formTable, formTextArea, formTreeGrid, formUpload } from 'mockdata';
import { configureTestSuite } from 'ng-bullet';
import { MessageService } from 'primeng/api';
import { ChartModule } from 'primeng/chart';
import { KeyFilterModule } from 'primeng/keyfilter';
import { AccordionModule, CalendarModule, CheckboxModule, DataTableModule, DropdownModule, EditorModule, FileUploadModule, GrowlModule, InputSwitchModule, ListboxModule, PickListModule, RadioButtonModule, TreeTableModule } from 'primeng/primeng';
