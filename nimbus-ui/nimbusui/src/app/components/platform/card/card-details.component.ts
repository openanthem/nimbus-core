  ...
  setCardConfig() {
    if (
      this.element.config.uiStyles.attributes.alias ===
        this.componentTypes.cardDetail.toString() &&
      this.element.config.uiStyles.attributes.expandable
    ) {
      ...
      this.element.config.uiStyles.attributes.alias ===
        this.componentTypes.cardDetail.toString() &&
      this.element.config.uiStyles.attributes.border
    ) {
  ...
  getFieldClass(parent: Param, child: Param) {
    if (child.config.uiStyles) {
      if (
        ...
        if (
          parent.config.uiStyles &&
          parent.config.uiStyles.attributes &&
          parent.config.uiStyles.attributes.cssClass
        ) {
