...
export class NmChart {
  ...
  ngOnInit() {
    ...
    if (
      this.chartType !== ChartType.pie.toString() &&
      this.chartType !== ChartType.doughnut.toString()
    ) {
      this.options = {
        scales: {
          xAxes: [
            {
              scaleLabel: {
                display: this.element.config.uiStyles.attributes.xAxisLabel
                  ? true
                  : false,
          ...
          yAxes: [
            {
              scaleLabel: {
                display: this.element.config.uiStyles.attributes.yAxisLabel
                  ? true
                  : false,
              ...
              ticks: {
                fontStyle: 'bold',
                stepSize: this.element.config.uiStyles.attributes.stepSize
                  ? this.element.config.uiStyles.attributes.stepSize
                  : null
              }
            }
          ]
